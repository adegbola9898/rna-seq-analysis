...
# Copy custom scripts into the container's root directory
COPY ensembl_transcript_to_amino_acid_sequence.py /
COPY load_rsem_results_into_bq.py /

# Make the scripts executable
RUN chmod +x /ensembl_transcript_to_amino_acid_sequence.py
RUN chmod +x /load_rsem_results_into_bq.py
